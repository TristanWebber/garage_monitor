...
The fact that this writing this README took longer than actually creating the actual firmware should be some indication of how straightforward developing in the Arduino framework is for a simple use case such as this one. That is a very strong 'pro' for developing simple projects in the Arduino framework. Another pro is that this works and is robust. This will happily sit for months and years, transmitting data and gracefully managing failures to the connection or sensors.
